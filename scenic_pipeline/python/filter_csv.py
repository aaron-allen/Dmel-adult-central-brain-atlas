...
parser.add_argument('--umi_counts', default = 3,
                    help = 'UMI counts to use for gene filtering, genes must have greater than umi_counts * min_percent * numberofcells counts to be retained')
parser.add_argument('--min_percent', default = 0.01,
                    help = 'percentage of cells for gene filtering, genes must have greater than min_percent * numberofcells counts to be retained')
parser.add_argument('--output', default = 'filtered_expression.dir/raw.dir/merged-all.dir/filtered-expression.csv',
