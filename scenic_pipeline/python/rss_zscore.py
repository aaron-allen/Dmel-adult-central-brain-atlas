...
parser.add_argument('--sample', default = 'merged-all',
                    help = 'sample name')
parser.add_argument('--exp_mtx', default = '../.../filtered-expression.dir/normalised.dir/merged-all.dir/filtered-expression.csv',    # genes x cells
                    help = 'path to h5ad-formatted hdf5 file containing AnnData object')
parser.add_argument('--aucell_output', default = 'raw.dir/merged-all.dir/aucell.csv',
                    help = 'Output from pyscenic aucell, matrix of AUCell scores')
parser.add_argument('--annotation_input', default = 'cluster-annotation.csv,stimulation-annotation.csv',
...
for i, annotation in enumerate(annotation_files):
    annotation = pd.read_csv('../../data.dir/' + annotation, squeeze = True,
...
for annotation_name in annotation_dict.keys():
    ...
    rss.to_csv(datatype + '.dir/' + sample + '.dir/' + annotation_name +
               '_RSS.csv', index = False)
...
auc_mtx_Z.to_csv(datatype + '.dir/' + sample + '.dir/aucell_zscores.csv')
...
for annotation_name in annotation_dict.keys():
    ...
    aucell_score.to_csv(datatype + '.dir/' + sample + '.dir/aucell_zscores_' + annotation_name + '.csv', index = False)
    ...
    aucell_score_3.to_csv(datatype + '.dir/' + sample + '.dir/aucell_zscores_' + annotation_name + '_specific_regulators_3.csv', index = False)
    ...
    aucell_score_2.to_csv(datatype + '.dir/' + sample + '.dir/aucell_zscores_' + annotation_name + '_specific_regulators_2.csv', index = False)
