...
parser.add_argument('--sample', default = 'merged-all',
                    help = 'sample name')
parser.add_argument('--ctx_output', default = 'raw.dir/merged-all.dir/reg.csv',
...
with open(datatype + ".dir/" + sample + ".dir/regulons.P", 'wb') as f:
...
regulon_df.to_csv(datatype + ".dir/" + sample + ".dir/regulons.csv", index = False)
