...
parser.add_argument('--sample', default = 'merged-all',
                    help = 'sample name')
parser.add_argument('--exp_mtx', default = '../../filtered_expression.dir/raw.dir/merged-all.dir/filtered-expression.csv',    # genes x cells
...
fig.tight_layout()
plt.savefig(datatype + ".dir/" + sample +
            ".dir/plots.dir/number_of_genes_expressed_above_AUC_thresholds.png")
plt.close()
...
sns_plot.savefig(datatype + ".dir/" + sample +
                 ".dir/plots.dir/aucell_heatmap.png")
