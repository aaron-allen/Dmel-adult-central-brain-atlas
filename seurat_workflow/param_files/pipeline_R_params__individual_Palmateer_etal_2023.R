...
# paths etc
raw_path <- file.path("/project/cncb/shared/proj103/analyses/alevin/fru_iso/Alevin_r_6.30_allcb/")
raw_names <- list("female_rep1_rna", "female_rep2_rna", "male_rep3_rna", "male_rep4_rna")
sample_names <- list("female_rep1", "female_rep2", "male_rep3", "male_rep4")
...
max_umi <- 20000         # used to filter seurat object
max_genes <- 4000       # used to filter seurat object
max_mito <- 5         # used to filter seurat object
...
integration <- "none"                  # options "harmony", "cca"
var_gene_method <- "vst"        # options "mean.var.plot", "vst" ,"dispersion"
...
curr_res <- 1.5               # "ideal" cluster resolution
