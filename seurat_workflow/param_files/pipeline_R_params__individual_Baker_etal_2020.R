...
# paths etc
raw_path <- file.path("/project/cncb/shared/proj071/analyses/alevin/fru_iso/Alevin_r_6.30_allcb/")
raw_names <- list("SRR12016929_rna", "SRR12016930_rna", "SRR12016931_rna", "SRR12016932_rna", "SRR12016933_rna", "SRR12016934_rna", "SRR12016935_rna", "SRR12016936_rna")
sample_names <- list("male_suc_rep1", "male_suc_rep2", "male_coc_rep1", "male_coc_rep2", "female_suc_rep1", "female_suc_rep2", "female_coc_rep1", "female_coc_rep2")
