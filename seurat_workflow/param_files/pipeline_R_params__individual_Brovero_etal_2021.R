...
raw_path <- file.path("/project/cncb/shared/proj079/analyses/alevin/fru_iso/multiple/Alevin_r_6.30_allcb/")
raw_names <- list("48hrAPF_Male_rna")
sample_names <- list("48hrAPF_Male")
