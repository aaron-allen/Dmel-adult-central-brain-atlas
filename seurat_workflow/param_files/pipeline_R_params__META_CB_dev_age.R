...
gmt_file_path <- "../../../aallen/gene_lists/gmt/D_melanogaster_broad_celltype_markers.gmt"
...
user_gene_list_file <- "../../../aallen/gene_lists/gene_sets/TFs.tsv"
...
harmony_group <- c("orig.ident", "sex", "dev_age")
...
vars_to_regress <- c("orig.ident", "nCount_RNA", "dev_age")  #, "sex"
...
# resolution_test <- c(seq(1, 5, 1), seq(6, 20, 2), seq(25, 50, 5))
