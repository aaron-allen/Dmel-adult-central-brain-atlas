...
# paths etc
##GEO
# file.path("/project/cncb/shared/proj132/analyses/GEO/")
# list(
# "GSM7903875_Dmel1", "GSM7903876_Dmel2", "GSM7903877_Dmel3", "GSM7903878_Dmel4", "GSM7903879_Dmel5", "GSM7903880_Dmel6", "GSM7975647_Dsim1", "GSM7975648_Dsim2", "GSM7975649_Dsim3", "GSM7975650_Dsim4",    
# "GSM7975651_Dsim5", "GSM7975652_Dsim6", "GSM7975653_Dsec1", "GSM7975654_Dsec2", "GSM7975655_Dsec3", "GSM7975656_Dsec4", "GSM7975657_Dsec5", "GSM7975658_Dsec6", "GSM7975659_DsecNoni1", "GSM7975660_DsecNoni2",
# "GSM7975661_DsecNoni3", "GSM7975662_DsecNoni4", "GSM7975663_DsecNoni5", "GSM7975664_DsecNoni6"
# )
# 
# list(
# "Dmel1", "Dmel2", "Dmel3", "Dmel4", "Dmel5", "Dmel6", "Dsim1", "Dsim2", "Dsim3", "Dsim4", "Dsim5", "Dsim6", "Dsec1", "Dsec2", "Dsec3", "Dsec4", "Dsec5", "Dsec6", "DsecNoni1",
# "DsecNoni2", "DsecNoni3", "DsecNoni4", "DsecNoni5", "DsecNoni6"
# )

# paths etc
raw_path <- file.path("/project/cncb/shared/proj132/analyses/alevin/fru_iso/Alevin_r_6.30_allcb/")
raw_names <- list(
    "GSM7903880_central_brain_sample1_rna", "GSM7903879_central_brain_sample2_rna",
    "GSM7903878_central_brain_sample3_rna", "GSM7903877_central_brain_sample4_rna",
    "GSM7903876_central_brain_sample5_rna", "GSM7903875_central_brain_sample6_rna"
)
sample_names <- list(
    "Dmel_cb_sample1", "Dmel_cb_sample2", "Dmel_cb_sample3", "Dmel_cb_sample4", "Dmel_cb_sample5", "Dmel_cb_sample6"
)
...
dictate_sex <- TRUE           # just specify which sex the data is
dictated_sex <- "female"
...
# SoupX get different results depending on how many genes per group are used. This
# parameter is used to specify how of the genes in the gmt file to use per cell type.
# The order of genes in the gmt file matters, and this will take the first n genes.
number_of_markers <- 1
...
annotation_cell_type <- c("Cholinergic", "Glutamatergic", "GABAergic", "Monoaminergic", "Glia")
