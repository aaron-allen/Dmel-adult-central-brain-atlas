...
# paths etc
raw_path <- file.path("/project/cncb/shared/proj074/analyses/alevin/fru_iso/Alevin_r_6.30_allcb/")
raw_names <- list("2019JUN_water_G1_rep1_rna", "2019JUN_water_G2_rep1_rna", "2019JUN_water_G3_rep1_rna", "2019JUN_water_G4_rep1_rna", "2019JUN_water_G1_rep2_rna", "2019JUN_water_G2_rep2_rna", "2019JUN_water_G3_rep2_rna", "2019JUN_water_G4_rep2_rna")
sample_names <- list("G1_rep1", "G2_rep1", "G3_rep1", "G4_rep1", "G1_rep2", "G2_rep2", "G3_rep2", "G4_rep2")
