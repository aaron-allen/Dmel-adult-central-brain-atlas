...
user_cells_remove_file <- "../analyses/cell_lists/New_Meta_cbNeuron_PUB4--cells_to_keep.csv"
...
max_pc <- 250                 # max pc to test in range of pcs
...
annotation_cell_type <- c("Cholinergic", "Glutamatergic", "GABAergic", "Monoaminergic", "Kenyon_cell", "Mechanoreceptors", "Chemoreceptors", "Photoreceptors", "Neuron", "Glia", "Hemocyte", "Epithelia", "Muscle", "Fat_cells")
