...
# paths etc
raw_path <- file.path("/project/cncb/shared/proj138/analyses/alevin/fru_iso/Alevin_r_6.30_allcb/")
raw_names <- list(
	"adult_eye_1_day_female_sample1_rna","adult_eye_1_day_male_sample4_rna","adult_eye_3_day_male_sample3_rna","adult_eye_7_day_male_sample2_rna"
)
sample_names <- list(
	"adult_eye_1_day_female_sample1","adult_eye_1_day_male_sample4","adult_eye_3_day_male_sample3","adult_eye_7_day_male_sample2"
...
min_umi  <- 300        # used to filter seurat object
min_genes <- 200       # used to filter seurat object
...
n_var_features <- 2000       # number of variable features to use for PCA
...
resolution_test <- c(seq(1, 5, 1), seq(6, 10, 2))
