...
# paths etc
raw_path <- file.path("/project/cncb/shared/proj063/analyses/alevin/fru_iso/Alevin_r_6.30_allcb/")
raw_names <- list("ol_rep1_rna", "ol_rep2_rna", "ol_rep3_rna", "ol_rep4_rna", "ol_rep5_rna",
                  "ol_rep6_rna", "ol_rep7_rna", "ol_rep8_rna", "ol_rep9_rna", "ol_rep10_rna",
                  "ol_rep11_rna", "ol_rep12_rna", "ol_rep13_rna", "ol_rep14_rna", "ol_rep15_rna"
                  )
sample_names <- list("ol_adult_rep1", "ol_adult_rep2", "ol_adult_rep3", "ol_adult_rep4", "ol_adult_rep5",
                  "ol_adult_rep6", "ol_adult_rep7", "ol_adult_rep8", "ol_adult_rep9", "ol_adult_rep10",
                  "ol_adult_rep11", "ol_adult_rep12", "ol_adult_rep13", "ol_adult_rep14", "ol_adult_rep15"
                  )
...
# gmt_file_path <- "/project/cncb/aallen/markers/D_melanogaster_celltype_markers.gmt"
