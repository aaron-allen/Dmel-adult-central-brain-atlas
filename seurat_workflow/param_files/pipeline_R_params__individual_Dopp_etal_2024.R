...
# paths etc
raw_path <- file.path("/project/cncb/shared/proj105/analyses/alevin/fru_iso/Alevin_r_6.30_allcb/")
raw_names <- list("sleep_rep1_rna", "sleep_rep2_rna", "sleep_rep3_rna", "sleep_rep4_rna", "sleep_rep5_rna", "sleep_rep6_rna", "sleep_rep7_rna")
sample_names <- list("sleep_rep1", "sleep_rep2", "sleep_rep3", "sleep_rep4", "sleep_rep5", "sleep_rep6", "sleep_rep7")
...
# will change the structure so this will be something like ...
...
# RunHarmony params
harmony_group <- c("orig.ident")   #, "Genotype", "ZT_Time"                , "sex"
...
vars_to_regress <- c("orig.ident", "nCount_RNA", "percent_mt", "percent_hsp")             # "Genotype", "ZT_Time",
sct_vars_to_regress <- setdiff(vars_to_regress, c("orig.ident", "nCount_RNA"))             #
...
annotation_cell_type <- c("Cholinergic", "Glutamatergic", "GABAergic", "Kenyon_cell", "Monoaminergic", "Glia")
