...
# paths etc
raw_path <- file.path("/project/cncb/shared/proj142/analyses/alevin/fru_iso/Alevin_r_6.30_allcb/")
...
user_cells_remove_file <- "../analyses/cell_lists/"
...
integration <- "none"                  # options "harmony", "cca", "none"
