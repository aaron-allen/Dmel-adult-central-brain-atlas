...
dataset <- "zip_optic_lobe_late"

# need to rethink this parameter doesn't quite work in new workflow
input_type <- "alevin"     # options - "cellranger","alevin"

# paths etc
raw_path <- file.path("/project/cncb/shared/proj139/analyses/alevin/fru_iso/Alevin_r_6.30_allcb/")

# raw_names <- list(
#     "optic_lobes_0_96h_APF_sample21_rna", "optic_lobes_0_96h_APF_sample22_rna", "optic_lobes_0_96h_APF_sample23_rna", "optic_lobes_0_96h_APF_sample24_rna",
#     "optic_lobes_0_96h_APF_sample25_rna", "optic_lobes_0_96h_APF_sample26_rna", "optic_lobes_0_96h_APF_sample27_rna", "optic_lobes_0_96h_APF_sample28_rna",
#     "optic_lobes_0_96h_APF_sample29_rna", "optic_lobes_0_96h_APF_sample30_rna", "optic_lobes_0_96h_APF_sample31_rna", "optic_lobes_0_96h_APF_sample32_rna",
#     "optic_lobes_0_96h_APF_sample33_rna", "optic_lobes_0_96h_APF_sample34_rna", "optic_lobes_0_96h_APF_sample35_rna", "optic_lobes_0_96h_APF_sample36_rna",
#     "optic_lobes_24h_APF_sample17_rna", "optic_lobes_24h_APF_sample18_rna", "optic_lobes_24h_APF_sample19_rna", "optic_lobes_24h_APF_sample20_rna",
#     "optic_lobes_48h_APF_sample10_rna", "optic_lobes_48h_APF_sample11_rna", "optic_lobes_48h_APF_sample12_rna", "optic_lobes_48h_APF_sample13_rna",
#     "optic_lobes_48h_APF_sample14_rna", "optic_lobes_48h_APF_sample15_rna", "optic_lobes_48h_APF_sample16_rna", "optic_lobes_48h_APF_sample9_rna",
#     "optic_lobes_72h_APF_sample5_rna", "optic_lobes_72h_APF_sample6_rna", "optic_lobes_72h_APF_sample7_rna", "optic_lobes_72h_APF_sample8_rna",
#     "optic_lobes_96h_APF_sample1_rna", "optic_lobes_96h_APF_sample2_rna", "optic_lobes_96h_APF_sample3_rna", "optic_lobes_96h_APF_sample4_rna"
# )
# 
# 
# sample_names <- list(
#     "optic_lobes_0_96h_APF_sample21", "optic_lobes_0_96h_APF_sample22", "optic_lobes_0_96h_APF_sample23", "optic_lobes_0_96h_APF_sample24",
#     "optic_lobes_0_96h_APF_sample25", "optic_lobes_0_96h_APF_sample26", "optic_lobes_0_96h_APF_sample27", "optic_lobes_0_96h_APF_sample28",
#     "optic_lobes_0_96h_APF_sample29", "optic_lobes_0_96h_APF_sample30", "optic_lobes_0_96h_APF_sample31", "optic_lobes_0_96h_APF_sample32",
#     "optic_lobes_0_96h_APF_sample33", "optic_lobes_0_96h_APF_sample34", "optic_lobes_0_96h_APF_sample35", "optic_lobes_0_96h_APF_sample36",
#     "optic_lobes_24h_APF_sample17", "optic_lobes_24h_APF_sample18", "optic_lobes_24h_APF_sample19", "optic_lobes_24h_APF_sample20",
#     "optic_lobes_48h_APF_sample10", "optic_lobes_48h_APF_sample11", "optic_lobes_48h_APF_sample12", "optic_lobes_48h_APF_sample13",
#     "optic_lobes_48h_APF_sample14", "optic_lobes_48h_APF_sample15", "optic_lobes_48h_APF_sample16", "optic_lobes_48h_APF_sample9",
#     "optic_lobes_72h_APF_sample5", "optic_lobes_72h_APF_sample6", "optic_lobes_72h_APF_sample7", "optic_lobes_72h_APF_sample8",
#     "optic_lobes_96h_APF_sample1", "optic_lobes_96h_APF_sample2", "optic_lobes_96h_APF_sample3", "optic_lobes_96h_APF_sample4"
# )
...
min_pc <- 20                 # min pc to test in range of pcs
max_pc <- 80                 # max pc to test in range of pcs
step_pc <- 20                # step size from min to max pc to test in range of pcs
...
scale_all_features <- FALSE                    # options: TRUE, FALSE - whether to scale all featuresonly or only variable features
vars_to_regress <- c("orig.ident", "nCount_RNA")   #, "sex", "percent_mt", "percent_hsp"
...
resolution_test <- c(seq(1, 5, 1), seq(6, 10, 2), seq(15, 20, 5))
...
annotation_cell_type <- c("Cholinergic", "Glutamatergic", "GABAergic", "Monoaminergic", "Kenyon_cell", "Glia", "Photoreceptors", "Hemocyte", "Epithelia", "Muscle", "Fat_cells")
...
manual_thresh <- FALSE
manual_thresholds <- c(0, 0.005, 0.005, 0.025, 0.012)
