...
min_pc <- 40                 # min pc to test in range of pcs
max_pc <- 260                 # max pc to test in range of pcs
...
harmony_group <- c("orig.ident", "experiment", "sex", "stage")
...
vars_to_regress <- c("orig.ident", "nCount_RNA", "sex", "stage")  #, "sex"
